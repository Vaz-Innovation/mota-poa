...
const translations: Record<Language, any> = {
  pt: {
    ...
    about: {
      title: "Sobre Nós",
      intro:
        "Conheça mais sobre nossa história, valores e compromisso com a excelência jurídica.",
    ...
    processConsultation: {
      ...
      successMessage:
        "Você receberá a atualização do processo em seu e-mail em breve.",
      error: "Erro",
    ...
    latestNews: {
      ...
      subtitle:
        "Fique por dentro das novidades jurídicas e atualizações do nosso escritório.",
      viewAll: "Ver todas as notícias",
    },
    avalie: {
      heroTitle: "Sua opinião é importante",
      heroSubtitle:
        "Ajude-nos a continuar oferecendo serviços jurídicos de excelência",
    ...
    trabalheConosco: {
      ...
      fields: {
        ...
        messagePlaceholder:
          "Conte-nos sobre sua experiência e por que deseja trabalhar conosco...",
      },
      roles: {
        intern: "Estagiário",
    ...
    admin: {
      ...
      metaDescriptionHint:
        "Máx. 160 caracteres. Deixe em branco para usar o resumo.",
      ...
      importSuccess:
        "Conteúdo importado com sucesso! Revise antes de publicar.",
  ...
  es: {
    ...
    about: {
      ...
      intro:
        "Conozca más sobre nuestra historia, valores y compromiso con la excelencia jurídica.",
      learnMore: "Más información →",
      sectionTitle: "Oficina",
      sectionSubtitle:
        "Construyendo soluciones jurídicas con excelencia, ética y resultados desde 2000 con actuación nacional",
      explore: "Explorar",
      trajectory: {
        title: "Trayectoria",
        badge: "Desde 2000",
        ...
        content1:
          "MOTA & ABOGADOS ASOCIADOS es una sociedad de abogados desde 2000, con actuación nacional.",
        content2:
      ...
      pillars: {
        ...
        content3:
          "Nuestra actuación, sea de forma preventiva, administrativa o judicial, está enfocada en la búsqueda de la garantía de los derechos, en la seguridad jurídica, valorizando principalmente nuestro punto más fuerte: las personas y la satisfacción con el trabajo desarrollado.",
      },
      mission: {
    ...
    practiceAreas: {
      ...
      subtitle:
        "Especializados en Derecho Constitucional y actuantes en diversas áreas del Derecho.",
      learnMore: "Más información",
      ...
      areas: {
        ...
        labor: {
          ...
          details:
            "Reclamaciones laborales (horas extras, peligrosidad/insalubridad, promociones, adicional de transferencia, vínculo laboral, estabilidad de gestante, solicitud de complementación de jubilación, multa 40% FGTS, función gratificada, accidente de trabajo), seguimiento en audiencias, medidas cautelares, contestaciones.",
        },
        union: {
          title: "Derecho Sindical",
          description: "Asesoría completa para entidades sindicales",
          details:
            "Nuestro despacho administra una cartera de grandes clientes constituida por numerosas asociaciones, sindicatos y otras entidades representativas de los servidores públicos, actuando en el ámbito administrativo y judicial.",
        },
        socialSecurity: {
          title: "Derecho Previsional",
          description: "Concesión y revisión de beneficios previsionales",
          details:
            "Actuamos en el Régimen Propio de Previsión de los Servidores Públicos, en el Régimen General y en los regímenes de previsión complementaria, abarcando servidores y empleados públicos.",
        },
        constitutional: {
          title: "Derecho Constitucional",
          description: "Elaboración de ADI y recursos extraordinarios",
          details:
            "Área de especialización del despacho relacionada con el seguimiento, elaboración y desarrollo de tesis jurídicas que involucran temas de naturaleza constitucional.",
        },
        criminal: {
          title: "Derecho Penal",
          description: "Habeas Corpus y recursos criminales",
          details:
            "El Derecho Penal pasó a integrar recientemente las áreas de actuación de nuestro despacho. Trabajamos en asociación con profesionales de amplia experiencia.",
        },
        electoral: {
          title: "Derecho Electoral",
          description: "Asesoría electoral completa",
          details:
            "Asesoría electoral a partidos, candidatos, elaboración de recursos, sustentación oral y demás providencias de orden administrativa ante Tribunales Regionales Electorales y Tribunal Superior Electoral.",
        },
        superiorCourts: {
          title: "Tribunales Superiores",
          description: "Actuación en Brasilia ante los Tribunales Superiores",
          details:
            "MOTA & ABOGADOS ASOCIADOS es uno de los despachos con intensa actuación en los Tribunales Superiores, especialmente STJ, TST y STF.",
        },
        realEstate: {
          ...
          details:
            "Actuamos en todos los frentes del derecho inmobiliario, incluyendo estructuración de negocios, cobro de deudas, asesoría en compra, venta y alquiler.",
        },
        family: {
          title: "Derecho de Familia y Sucesiones",
          description: "Inventarios, divorcios, pensiones y sucesiones",
          details:
            "Dedicamos atención especial a esta área debido a su conexión con otras áreas de nuestro trabajo, por lo que estructuramos un departamento exclusivo.",
        },
        publicTreasury: {
          title: "Hacienda Pública y Entes Federados",
          description: "Acciones contra Unión, Estados, DF y Municipios",
          details:
            "Esta área de actuación abarca acciones de cobro, indemnizaciones, ejecuciones contra Hacienda Pública de la Unión, Estados, DF y Municipios.",
        },
        mediation: {
          title: "Mediación y Conciliación",
          description: "Métodos alternativos de resolución de conflictos",
          details:
            "Se trata de un área dedicada a métodos alternativos de resolución de conflictos, conducida por profesionales especializados en técnicas de negociación.",
        },
        taxBusiness: {
          title: "Derecho Tributario y Empresarial",
          description: "Asesoría jurídica para empresas y materia tributaria",
          details:
            "Ante la creciente demanda en esta área, el despacho estructuró un equipo exclusivo, coordinado por abogados especializados.",
        },
      },
    },
    lawyers: {
      title: "Socios",
      intro:
        "Conozca los socios que lideran MOTA & ABOGADOS ASOCIADOS con excelencia y compromiso.",
      swipeHint: "← Desliza para navegar →",
      prev: "Anterior",
      next: "Siguiente",
    },
    contact: {
      ...
      toastGenericErrorDescription:
        "Ocurrió un error al enviar su mensaje. Inténtelo de nuevo.",
      validation: {
    ...
    processConsultation: {
      ...
      description:
        "Ingrese el número del proceso y reciba actualizaciones en pocos minutos.",
      processNumberPlaceholder:
        "Número de proceso (ej: 0000000-00.0000.0.00.0000)",
      ...
      successMessage:
        "Recibirá la actualización del proceso en su correo pronto.",
      error: "Error",
    ...
    newsletter: {
      ...
      description:
        "Suscríbase al boletín y reciba consejos jurídicos y novedades del despacho.",
    ...
    footer: {
      description:
        "Excelencia en abogacía con ética, transparencia y compromiso.",
    ...
    cookies: {
      title: "Política de Cookies",
      message:
        "Utilizamos cookies para mejorar su experiencia en nuestro sitio. Al continuar navegando, acepta nuestra política de privacidad.",
      accept: "Aceptar",
      decline: "Rechazar",
    },
    blog: {
    ...
    latestNews: {
      ...
      subtitle:
        "Mantente informado sobre las novedades jurídicas y actualizaciones de nuestro despacho.",
      viewAll: "Ver todas las noticias",
    },
    avalie: {
      heroTitle: "Tu opinión es importante",
      heroSubtitle:
        "Ayúdanos a seguir ofreciendo servicios jurídicos de excelencia",
    ...
    trabalheConosco: {
      ...
      heroSubtitle:
        "Únete a nosotros y construye el futuro de la abogacía con ética, innovación y compromiso con resultados.",
      ...
      fields: {
        ...
        messagePlaceholder:
          "Cuéntanos sobre tu experiencia y por qué quieres trabajar con nosotros...",
      },
      roles: {
        intern: "Practicante",
      ...
      resumeBox: {
        ...
        description:
          "Después de enviar este formulario, serás redirigido a WhatsApp donde podrás adjuntar tu currículum.",
      },
      submit: "Enviar",
      submitting: "Enviando...",
      ...
      toastGenericErrorTitle: "Error",
      toastGenericErrorDescription:
        "Ocurrió un error al enviar tu candidatura. Inténtalo de nuevo.",
      validation: {
        nameRequired: "El nombre es obligatorio",
        nameTooLong: "Nombre demasiado largo",
        emailInvalid: "Correo electrónico inválido",
    ...
    admin: {
      ...
      noCategoriesFound:
        "No se encontraron categorías. ¡Cree su primera categoría!",
      name: "Nombre",
      slug: "Slug",
      deleteCategory: "¿Eliminar categoría?",
      deleteCategoryDesc:
        "Esta acción no se puede deshacer. Los posts vinculados quedarán sin categoría.",
      accessDenied: "Acceso Denegado",
      accessDeniedDesc:
        "No tiene permiso para acceder a esta página. Contacte al administrador.",
      backToSite: "Volver al Sitio",
      ...
      importFromUrlDesc:
        "Pegue el enlace de un artículo para completar automáticamente con IA",
      ...
      htmlHint:
        "Puede usar HTML para formato (h2, h3, p, ul, li, strong, em, a, etc.)",
      ...
      metaDescriptionHint:
        "Máx. 160 caracteres. Deje en blanco para usar el resumen.",
      ...
      importSuccess:
        "¡Contenido importado con éxito! Revise antes de publicar.",
      ...
      validation: {
        ...
        metaDescriptionMax:
          "La meta descripción debe tener máximo 160 caracteres",
  ...
  en: {
    ...
    about: {
      title: "About Us",
      intro:
        "Learn more about our history, values and commitment to legal excellence.",
      learnMore: "Learn more →",
      sectionTitle: "Office",
      sectionSubtitle:
        "Building legal solutions with excellence, ethics and results since 2000 with national coverage",
      explore: "Explore",
      trajectory: {
        title: "Trajectory",
        badge: "Since 2000",
        ...
        content1:
          "MOTA & LAWYERS ASSOCIATES is a law firm since 2000, with national coverage.",
        content2:
          "Providing excellent legal services is our goal and is reflected in the results achieved and in our clients' satisfaction.",
      },
      pillars: {
        ...
        content1:
          "MOTA & LAWYERS ASSOCIATES has its practice founded on the principles of ethical advocacy, committed, serious and efficient work, attentive to changes in society and the needs of each client, without dispensing with good technique and the lawyer's social role in the search for effective solutions.",
        content2:
        ...
        content3:
          "Our practice, whether preventive, administrative or judicial, is focused on seeking the guarantee of rights, legal security, valuing mainly our strongest point: people and satisfaction with the work developed.",
      },
      mission: {
        title: "Our Mission",
        badge: "Excellence",
        ...
        content:
          "We are part of a constantly evolving society, which reflects the need for continuous training of our team. Legislative, regulatory and jurisprudential changes require more and more technical qualification and the incorporation of new technologies, so that the service to our clients provides satisfaction, achieves efficiency, resolution and, above all, agility.",
      },
      office: {
        title: "Office",
    ...
    practiceAreas: {
      ...
      subtitle:
        "Specialized in Constitutional Law and practicing in various areas of Law.",
      learnMore: "Learn more",
      ...
      areas: {
        administrative: {
          ...
          details:
            "Throughout our trajectory we have consolidated ourselves as one of the largest law firms in the country in defending the professional rights and interests of public servants, acting decisively in thousands of lawsuits that ensured public servants the recognition of their rights.",
        },
        labor: {
          title: "Individual and Collective Labor Law",
          description: "Labor claims and procedural follow-up",
          details:
            "Labor claims (overtime, hazard/unhealthiness pay, promotions, transfer allowance, employment relationship, maternity stability, retirement supplement request, 40% FGTS fine, gratified function, work accident), hearing accompaniment, precautionary measures, contestations.",
        },
        union: {
          title: "Union Law",
          description: "Complete advisory for union entities",
          details:
            "Our firm manages a portfolio of major clients consisting of numerous associations, unions and other representative entities of public servants, acting in the administrative and judicial spheres.",
        },
        socialSecurity: {
          title: "Social Security Law",
          description: "Granting and revision of social security benefits",
          details:
            "We work in the Public Servants Own Social Security Regime, in the General Regime and in complementary social security regimes, covering public servants and employees.",
        },
        constitutional: {
          title: "Constitutional Law",
          description: "Preparation of ADI and extraordinary appeals",
          details:
            "Specialty area of the firm related to the monitoring, preparation and development of legal theses involving constitutional matters.",
        },
        criminal: {
          title: "Criminal Law",
          description: "Habeas Corpus and criminal appeals",
          details:
            "Criminal Law has recently become part of our firm practice areas. We work in partnership with highly experienced professionals.",
        },
        electoral: {
          title: "Electoral Law",
          description: "Complete electoral advisory",
          details:
            "Electoral advisory to parties, candidates, preparation of appeals, oral arguments and other administrative measures before Regional Electoral Courts and Superior Electoral Court.",
        },
        superiorCourts: {
          title: "Superior Courts",
          description: "Practice in Brasilia before Superior Courts",
          details:
            "MOTA & LAWYERS ASSOCIATES is one of the firms with intense activity in the Superior Courts, especially STJ, TST and STF.",
        },
        realEstate: {
          title: "Real Estate Law",
          description:
            "Complete advisory in business and real estate regularization",
          details:
            "We work on all fronts of real estate law, including business structuring, debt collection, advisory in buying, selling and leasing.",
        },
        family: {
          title: "Family and Succession Law",
          description: "Inventories, divorces, alimony and successions",
          details:
            "We dedicate special attention to this area due to its connection with other fronts of our work, which is why we have structured an exclusive department.",
        },
        publicTreasury: {
          title: "Public Treasury and Federated Entities",
          description: "Actions against Union, States, DF and Municipalities",
          details:
            "This practice area covers collection actions, indemnities, executions against the Public Treasury of the Union, States, DF and Municipalities.",
        },
        mediation: {
          title: "Mediation and Conciliation",
          description: "Alternative methods of conflict resolution",
          details:
            "This is an area dedicated to alternative methods of conflict resolution, conducted by professionals specialized in negotiation techniques.",
        },
        taxBusiness: {
          title: "Tax and Business Law",
          description: "Legal advisory for companies and tax matters",
          details:
            "Given the growing demand in this area, the firm has structured an exclusive team, coordinated by specialized lawyers.",
        },
      },
    },
    lawyers: {
      title: "Partners",
      intro:
        "Meet the partners who lead MOTA & LAWYERS ASSOCIATES with excellence and commitment.",
      swipeHint: "← Swipe to navigate →",
      prev: "Previous",
      next: "Next",
    },
    ...
    processConsultation: {
      ...
      description:
        "Enter the case number and receive updates in just a few minutes.",
    ...
    newsletter: {
      title: "Stay Informed",
      description:
        "Subscribe to the newsletter and receive legal tips and firm updates.",
    ...
    footer: {
      description:
        "Excellence in law with ethics, transparency and commitment.",
    ...
    latestNews: {
      ...
      title: "Latest News",
      subtitle:
        "Stay informed about the latest legal updates and news from our firm.",
    ...
    trabalheConosco: {
      ...
      heroSubtitle:
        "Join us and help build the future of legal practice with ethics, innovation, and a commitment to results.",
      ...
      benefits: {
        ...
        challengingDesc:
          "Take part in complex and relevant cases across different areas of law.",
        growthTitle: "Professional Growth",
        growthDesc:
          "Grow your career at a firm with tradition and legal excellence.",
      },
      ...
      fields: {
        ...
        messagePlaceholder:
          "Tell us about your experience and why you want to work with us...",
      },
      roles: {
        intern: "Intern",
      ...
      resumeBox: {
        title: "Resume Upload",
        description:
          "After submitting this form, you will be redirected to WhatsApp where you can attach your resume.",
      },
      submit: "Send",
      submitting: "Sending...",
    ...
    admin: {
      ...
      deleteCategoryDesc:
        "This action cannot be undone. Linked posts will be left without category.",
      ...
      htmlHint:
        "You can use HTML for formatting (h2, h3, p, ul, li, strong, em, a, etc.)",
  ...
  de: {
    ...
    hero: {
      banner1: {
        ...
        title: "Für Sie",
        description:
          "Über 15 Jahre Erfahrung in der Umwandlung von Herausforderungen in Lösungen.",
    ...
    about: {
      title: "Über Uns",
      intro:
        "Erfahren Sie mehr über unsere Geschichte, Werte und unser Engagement für juristische Exzellenz.",
      learnMore: "Mehr erfahren →",
      sectionTitle: "Kanzlei",
      sectionSubtitle:
        "Juristische Lösungen mit Exzellenz, Ethik und Ergebnissen seit 2000 mit nationaler Reichweite",
      explore: "Erkunden",
      trajectory: {
        title: "Geschichte",
        badge: "Seit 2000",
        ...
        content1:
          "MOTA & RECHTSANWÄLTE PARTNER ist eine Anwaltskanzlei seit 2000 mit nationaler Reichweite.",
        content2:
          "Exzellente Rechtsdienstleistungen zu erbringen ist unser Ziel und spiegelt sich in den erzielten Ergebnissen und der Zufriedenheit unserer Mandanten wider.",
      },
      pillars: {
        title: "Konsolidierte Grundsätze",
        badge: "Ethik | Engagement",
        summary:
          "Die Grundsätze einer Anwaltspraxis, die Ethik, Exzellenz und Ergebnisse vereint",
        content1:
          "MOTA & RECHTSANWÄLTE PARTNER hat seine Praxis auf den Grundsätzen ethischer Rechtsvertretung, engagierter, seriöser und effizienter Arbeit gegründet, aufmerksam auf gesellschaftliche Veränderungen und die Bedürfnisse jedes Mandanten, ohne auf gute Technik und die soziale Rolle des Anwalts bei der Suche nach effektiven Lösungen zu verzichten.",
        content2:
          "Unser Ziel ist es, das Gleichgewicht der sozialen Beziehungen durch rechtlich kompetente Arbeit zu fördern und die professionelle Beziehung zum Mandanten zu priorisieren.",
        content3:
          "Unsere Praxis, ob präventiv, administrativ oder gerichtlich, konzentriert sich auf die Garantie der Rechte, die Rechtssicherheit und schätzt vor allem unsere größte Stärke: die Menschen und die Zufriedenheit mit der geleisteten Arbeit.",
      },
      mission: {
    ...
    practiceAreas: {
      ...
      subtitle:
        "Spezialisiert auf Verfassungsrecht und tätig in verschiedenen Rechtsgebieten.",
      learnMore: "Mehr erfahren",
      ...
      areas: {
        administrative: {
          ...
          details:
            "Im Laufe unserer Geschichte haben wir uns als eine der größten Anwaltskanzleien des Landes bei der Verteidigung der beruflichen Rechte und Interessen von Beamten etabliert.",
        },
        labor: {
          title: "Individual- und Kollektivarbeitsrecht",
          description: "Arbeitsklagen und Prozessbegleitung",
          details:
            "Arbeitsklagen (Überstunden, Gefahren-/Gesundheitszulage, Beförderungen, Versetzungszulage, Arbeitsverhältnis, Mutterschutz, Rentenergänzungsantrag, 40% FGTS-Strafe, Gratifikationsfunktion, Arbeitsunfall).",
        },
        union: {
          title: "Gewerkschaftsrecht",
          description: "Vollständige Beratung für Gewerkschaften",
          details:
            "Unsere Kanzlei verwaltet ein Portfolio großer Kunden, bestehend aus zahlreichen Verbänden, Gewerkschaften und anderen Vertretungsorganen der Beamten.",
        },
        socialSecurity: {
          ...
          details:
            "Wir arbeiten im eigenen Sozialversicherungssystem der Beamten, im allgemeinen System und in ergänzenden Sozialversicherungssystemen.",
        },
        constitutional: {
          title: "Verfassungsrecht",
          description: "Erstellung von ADI und außerordentlichen Rechtsmitteln",
          details:
            "Fachgebiet der Kanzlei im Zusammenhang mit der Überwachung, Erstellung und Entwicklung rechtlicher Thesen zu verfassungsrechtlichen Themen.",
        },
        criminal: {
          title: "Strafrecht",
          description: "Habeas Corpus und Strafberufungen",
          details:
            "Das Strafrecht ist kürzlich zu unseren Tätigkeitsbereichen hinzugekommen. Wir arbeiten in Partnerschaft mit hocherfahrenen Fachleuten.",
        },
        electoral: {
          title: "Wahlrecht",
          description: "Vollständige Wahlberatung",
          details:
            "Wahlberatung für Parteien, Kandidaten, Erstellung von Rechtsmitteln, mündliche Vorträge und andere Verwaltungsmaßnahmen vor Wahlgerichten.",
        },
        superiorCourts: {
          title: "Oberste Gerichte",
          description: "Tätigkeit in Brasília vor den Obersten Gerichten",
          details:
            "MOTA & RECHTSANWÄLTE PARTNER ist eine der Kanzleien mit intensiver Tätigkeit an den Obersten Gerichten, insbesondere STJ, TST und STF.",
        },
        realEstate: {
          title: "Immobilienrecht",
          description:
            "Vollständige Beratung in Immobiliengeschäften und -regularisierung",
          details:
            "Wir arbeiten an allen Fronten des Immobilienrechts, einschließlich Geschäftsstrukturierung, Inkasso, Beratung bei Kauf, Verkauf und Vermietung.",
        },
        family: {
          title: "Familien- und Erbrecht",
          description: "Inventare, Scheidungen, Unterhalt und Erbschaften",
          details:
            "Wir widmen diesem Bereich besondere Aufmerksamkeit aufgrund seiner Verbindung mit anderen Bereichen unserer Arbeit.",
        },
        publicTreasury: {
          title: "Öffentliche Finanzen und Föderale Einheiten",
          description: "Klagen gegen Bund, Länder, DF und Gemeinden",
          details:
            "Dieser Tätigkeitsbereich umfasst Inkassoklagen, Entschädigungen, Vollstreckungen gegen die öffentliche Kasse des Bundes, der Länder, DF und Gemeinden.",
        },
        mediation: {
          title: "Mediation und Schlichtung",
          description: "Alternative Methoden der Konfliktlösung",
          details:
            "Dies ist ein Bereich, der alternativen Methoden der Konfliktlösung gewidmet ist, durchgeführt von Fachleuten, die auf Verhandlungstechniken spezialisiert sind.",
        },
        taxBusiness: {
          ...
          details:
            "Angesichts der wachsenden Nachfrage in diesem Bereich hat die Kanzlei ein exklusives Team strukturiert, koordiniert von spezialisierten Anwälten.",
        },
      },
    },
    lawyers: {
      title: "Partner",
      intro:
        "Lernen Sie die Partner kennen, die MOTA & RECHTSANWÄLTE PARTNER mit Exzellenz und Engagement führen.",
      swipeHint: "← Wischen zum Navigieren →",
      prev: "Zurück",
      next: "Weiter",
    },
    ...
    newsletter: {
      ...
      description:
        "Abonnieren Sie den Newsletter und erhalten Sie juristische Tipps und Kanzlei-Neuigkeiten.",
    ...
    footer: {
      description:
        "Exzellenz in der Rechtspraxis mit Ethik, Transparenz und Engagement.",
    ...
    cookies: {
      ...
      message:
        "Wir verwenden Cookies, um Ihre Erfahrung auf unserer Website zu verbessern. Durch das Fortsetzen der Navigation stimmen Sie unserer Datenschutzrichtlinie zu.",
      accept: "Akzeptieren",
      decline: "Ablehnen",
    },
    blog: {
    ...
    latestNews: {
      ...
      subtitle:
        "Bleiben Sie über die neuesten juristischen Entwicklungen und Neuigkeiten unserer Kanzlei informiert.",
      viewAll: "Alle Nachrichten anzeigen",
    },
    avalie: {
      heroTitle: "Ihre Meinung ist wichtig",
      heroSubtitle:
        "Helfen Sie uns, weiterhin exzellente juristische Dienstleistungen anzubieten",
      cardTitle: "Bewerten Sie unsere Erfahrung",
      cardSubtitle:
        "Teilen Sie Ihre Erfahrung mit unseren Dienstleistungen auf Google",
      ...
      footerLine:
        "Exzellenz in juristischen Dienstleistungen seit über 20 Jahren",
    },
    trabalheConosco: {
      heroTitle: "Arbeiten Sie mit uns",
      heroSubtitle:
        "Schließen Sie sich uns an und gestalten Sie die Zukunft der Anwaltschaft mit Ethik, Innovation und Ergebnisorientierung.",
      ...
      benefits: {
        ...
        challengingDesc:
          "Arbeiten Sie an komplexen und relevanten Fällen in verschiedenen Rechtsgebieten mit.",
      ...
      fields: {
        ...
        messagePlaceholder:
          "Erzählen Sie uns von Ihrer Erfahrung und warum Sie bei uns arbeiten möchten...",
      },
      roles: {
      ...
      resumeBox: {
        ...
        description:
          "Nach dem Absenden dieses Formulars werden Sie zu WhatsApp weitergeleitet, wo Sie Ihren Lebenslauf anhängen können.",
      },
      submit: "Senden",
      submitting: "Wird gesendet...",
      ...
      toastGenericErrorTitle: "Fehler",
      toastGenericErrorDescription:
        "Beim Senden Ihrer Bewerbung ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut.",
      validation: {
        nameRequired: "Name ist erforderlich",
        nameTooLong: "Name ist zu lang",
        emailInvalid: "Ungültige E-Mail",
    ...
    admin: {
      ...
      noPostsFound:
        "Keine Beiträge gefunden. Erstellen Sie Ihren ersten Artikel!",
      title: "Titel",
      category: "Kategorie",
      status: "Status",
      date: "Datum",
      ...
      deleteCategoryDesc:
        "Diese Aktion kann nicht rückgängig gemacht werden. Verknüpfte Beiträge werden ohne Kategorie bleiben.",
      accessDenied: "Zugriff verweigert",
      accessDeniedDesc:
        "Sie haben keine Berechtigung, auf diese Seite zuzugreifen. Kontaktieren Sie den Administrator.",
      backToSite: "Zurück zur Website",
      ...
      importFromUrlDesc:
        "Fügen Sie einen Artikellink ein, um automatisch mit KI auszufüllen",
      ...
      excerpt: "Auszug",
      excerptPlaceholder:
        "Kurze Zusammenfassung des Artikels (erscheint in der Liste)",
      characters: "Zeichen",
      contentRequired: "Inhalt *",
      contentPlaceholder:
        "Schreiben Sie den Artikelinhalt... (unterstützt HTML)",
      htmlHint:
        "Sie können HTML zur Formatierung verwenden (h2, h3, p, ul, li, strong, em, a, etc.)",
      ...
      metaDescriptionHint:
        "Max. 160 Zeichen. Leer lassen, um den Auszug zu verwenden.",
      ...
      importSuccess:
        "Inhalt erfolgreich importiert! Vor der Veröffentlichung überprüfen.",
      ...
      validation: {
        ...
        metaDescriptionMax:
          "Die Meta-Beschreibung darf maximal 160 Zeichen haben",
        ...
        categoryDescriptionMax:
          "Die Beschreibung darf maximal 200 Zeichen haben",
      },
    },
  },
  it: {
    ...
    hero: {
      banner1: {
        ...
        title: "Per Te",
        description:
          "Oltre 15 anni di trasformazione delle sfide in soluzioni.",
        button: "Contattaci",
      },
      banner2: {
    ...
    about: {
      title: "Chi Siamo",
      intro:
        "Scopri di più sulla nostra storia, valori e impegno per l'eccellenza legale.",
      ...
      trajectory: {
        ...
        content1:
          "MOTA & AVVOCATI ASSOCIATI è uno studio legale dal 2000, con copertura nazionale.",
        content2:
          "Fornire servizi legali eccellenti è il nostro obiettivo e si riflette nei risultati raggiunti e nella soddisfazione dei nostri clienti.",
      },
      pillars: {
        ...
        content1:
          "MOTA & AVVOCATI ASSOCIATI ha la sua pratica fondata sui principi della difesa etica, del lavoro impegnato, serio ed efficiente, attento ai cambiamenti della società e alle esigenze di ogni cliente, senza rinunciare alla buona tecnica e al ruolo sociale dell'avvocato nella ricerca di soluzioni efficaci.",
        content2:
        ...
        content3:
          "La nostra pratica, sia essa preventiva, amministrativa o giudiziaria, è focalizzata sulla ricerca della garanzia dei diritti, della sicurezza giuridica, valorizzando principalmente il nostro punto di forza: le persone e la soddisfazione per il lavoro svolto.",
      },
      mission: {
      ...
      office: {
        ...
        content2:
          "Presenza su tutto il territorio, soluzioni in ogni dettaglio.",
    ...
    practiceAreas: {
      ...
      subtitle:
        "Specializzati in Diritto Costituzionale e operanti in diverse aree del Diritto.",
      learnMore: "Scopri di più",
      ...
      areas: {
        administrative: {
          ...
          details:
            "Nel corso della nostra storia ci siamo consolidati come uno dei più grandi studi legali del paese nella difesa dei diritti e interessi professionali dei dipendenti pubblici.",
        },
        labor: {
          title: "Diritto del Lavoro Individuale e Collettivo",
          description: "Reclami lavorativi e follow-up processuale",
          details:
            "Reclami lavorativi (straordinari, indennità di rischio/insalubrità, promozioni, indennità di trasferimento, rapporto di lavoro, stabilità maternità, richiesta di integrazione pensione).",
        },
        union: {
          title: "Diritto Sindacale",
          description: "Consulenza completa per enti sindacali",
          details:
            "Il nostro studio gestisce un portafoglio di grandi clienti costituito da numerose associazioni, sindacati e altri enti rappresentativi dei dipendenti pubblici.",
        },
        socialSecurity: {
          title: "Diritto Previdenziale",
          description: "Concessione e revisione dei benefici previdenziali",
          details:
            "Operiamo nel Regime Previdenziale Proprio dei Dipendenti Pubblici, nel Regime Generale e nei regimi di previdenza complementare.",
        },
        constitutional: {
          title: "Diritto Costituzionale",
          description: "Elaborazione di ADI e ricorsi straordinari",
          details:
            "Area di specializzazione dello studio relativa al monitoraggio, elaborazione e sviluppo di tesi giuridiche che coinvolgono questioni costituzionali.",
        },
        criminal: {
          title: "Diritto Penale",
          description: "Habeas Corpus e ricorsi penali",
          details:
            "Il Diritto Penale è recentemente entrato a far parte delle aree di pratica del nostro studio. Lavoriamo in collaborazione con professionisti di grande esperienza.",
        },
        electoral: {
          title: "Diritto Elettorale",
          description: "Consulenza elettorale completa",
          details:
            "Consulenza elettorale a partiti, candidati, elaborazione di ricorsi, arringhe orali e altre misure amministrative presso i Tribunali Elettorali.",
        },
        superiorCourts: {
          title: "Corti Superiori",
          description: "Attività a Brasilia presso le Corti Superiori",
          details:
            "MOTA & AVVOCATI ASSOCIATI è uno degli studi con intensa attività presso le Corti Superiori, in particolare STJ, TST e STF.",
        },
        realEstate: {
          ...
          details:
            "Operiamo su tutti i fronti del diritto immobiliare, inclusa la strutturazione aziendale, il recupero crediti, la consulenza in acquisto, vendita e locazione.",
        },
        family: {
          title: "Diritto di Famiglia e Successioni",
          description: "Inventari, divorzi, alimenti e successioni",
          details:
            "Dedichiamo particolare attenzione a quest area a causa della sua connessione con altre aree del nostro lavoro.",
        },
        publicTreasury: {
          title: "Tesoro Pubblico ed Enti Federati",
          description: "Azioni contro Unione, Stati, DF e Comuni",
          details:
            "Quest area di pratica copre azioni di recupero crediti, indennizzi, esecuzioni contro il Tesoro Pubblico dell Unione, Stati, DF e Comuni.",
        },
        mediation: {
          title: "Mediazione e Conciliazione",
          description: "Metodi alternativi di risoluzione dei conflitti",
          details:
            "Quest area è dedicata a metodi alternativi di risoluzione dei conflitti, condotta da professionisti specializzati in tecniche di negoziazione.",
        },
        taxBusiness: {
          title: "Diritto Tributario e Societario",
          description: "Consulenza legale per aziende e questioni fiscali",
          details:
            "Data la crescente domanda in quest area, lo studio ha strutturato un team esclusivo, coordinato da avvocati specializzati.",
        },
      },
    },
    lawyers: {
      title: "Partner",
      intro:
        "Conosci i partner che guidano MOTA & AVVOCATI ASSOCIATI con eccellenza e impegno.",
      swipeHint: "← Scorri per navigare →",
      prev: "Precedente",
      next: "Successivo",
    },
    ...
    processConsultation: {
      ...
      processNumberPlaceholder:
        "Numero del caso (es: 0000000-00.0000.0.00.0000)",
      fullNamePlaceholder: "Nome completo",
      cpfPlaceholder: "CPF/CNPJ",
    ...
    newsletter: {
      ...
      description:
        "Iscriviti alla newsletter e ricevi consigli legali e novità dello studio.",
    ...
    latestNews: {
      ...
      subtitle:
        "Rimani aggiornato sulle ultime novità legali e gli aggiornamenti del nostro studio.",
      viewAll: "Vedi tutte le notizie",
    },
    avalie: {
      heroTitle: "La tua opinione è importante",
      heroSubtitle:
        "Aiutaci a continuare a offrire servizi legali di eccellenza",
      cardTitle: "Valuta la nostra esperienza",
      cardSubtitle:
        "Condividi la tua esperienza con i nostri servizi su Google",
    ...
    trabalheConosco: {
      ...
      heroSubtitle:
        "Unisciti a noi e costruisci il futuro dell’avvocatura con etica, innovazione e impegno per i risultati.",
      ...
      benefits: {
        ...
        challengingDesc:
          "Partecipa a casi complessi e rilevanti in diverse aree del diritto.",
        growthTitle: "Crescita professionale",
        growthDesc:
          "Sviluppa la tua carriera in uno studio con tradizione ed eccellenza giuridica.",
      },
      ...
      fields: {
        ...
        messagePlaceholder:
          "Raccontaci la tua esperienza e perché vuoi lavorare con noi...",
      },
      roles: {
        intern: "Stagista",
      ...
      resumeBox: {
        title: "Invio del CV",
        description:
          "Dopo aver inviato questo modulo, verrai reindirizzato a WhatsApp dove potrai allegare il tuo CV.",
      },
      submit: "Invia",
      submitting: "Invio in corso...",
      ...
      toastGenericErrorTitle: "Errore",
      toastGenericErrorDescription:
        "Si è verificato un errore durante l’invio della candidatura. Riprova.",
      validation: {
        nameRequired: "Il nome è obbligatorio",
        nameTooLong: "Nome troppo lungo",
        emailInvalid: "Email non valida",
    ...
    admin: {
      ...
      deleteCategoryDesc:
        "Questa azione non può essere annullata. I post collegati rimarranno senza categoria.",
      accessDenied: "Accesso Negato",
      accessDeniedDesc:
        "Non hai il permesso di accedere a questa pagina. Contatta l'amministratore.",
      backToSite: "Torna al Sito",
      ...
      importFromUrlDesc:
        "Incolla un link di un articolo per compilare automaticamente con l'IA",
      ...
      contentPlaceholder:
        "Scrivi il contenuto dell'articolo... (supporta HTML)",
      htmlHint:
        "Puoi usare HTML per la formattazione (h2, h3, p, ul, li, strong, em, a, ecc.)",
      ...
      metaDescriptionHint:
        "Max. 160 caratteri. Lascia vuoto per usare l'estratto.",
      ...
      importSuccess:
        "Contenuto importato con successo! Rivedi prima di pubblicare.",
      ...
      validation: {
        ...
        metaDescriptionMax:
          "La meta descrizione deve avere massimo 160 caratteri",
  ...
  fr: {
    ...
    about: {
      ...
      intro:
        "Découvrez notre histoire, nos valeurs et notre engagement envers l'excellence juridique.",
      learnMore: "En savoir plus →",
      sectionTitle: "Cabinet",
      sectionSubtitle:
        "Construire des solutions juridiques avec excellence, éthique et résultats depuis 2000 avec une couverture nationale",
      explore: "Explorer",
      trajectory: {
        title: "Trajectoire",
        badge: "Depuis 2000",
        ...
        content1:
          "MOTA & AVOCATS ASSOCIÉS est un cabinet d'avocats depuis 2000, avec une couverture nationale.",
        content2:
          "Fournir d'excellents services juridiques est notre objectif et se reflète dans les résultats obtenus et la satisfaction de nos clients.",
      },
      pillars: {
        ...
        content1:
          "MOTA & AVOCATS ASSOCIÉS a sa pratique fondée sur les principes d'une défense éthique, d'un travail engagé, sérieux et efficace, attentif aux changements de la société et aux besoins de chaque client, sans renoncer à la bonne technique et au rôle social de l'avocat dans la recherche de solutions efficaces.",
        content2:
          "Notre objectif est de promouvoir l'équilibre des relations sociales grâce à la prestation d'un travail juridiquement compétent, en privilégiant la relation professionnelle avec le client.",
        content3:
          "Notre pratique, qu'elle soit préventive, administrative ou judiciaire, est axée sur la recherche de la garantie des droits, de la sécurité juridique, en valorisant principalement notre point le plus fort: les personnes et la satisfaction du travail accompli.",
      },
      mission: {
        title: "Notre Mission",
        badge: "Excellence",
    ...
    practiceAreas: {
      ...
      subtitle:
        "Spécialisés en Droit Constitutionnel et pratiquant dans divers domaines du Droit.",
      learnMore: "En savoir plus",
      ...
      areas: {
        administrative: {
          ...
          details:
            "Au cours de notre histoire, nous nous sommes consolidés comme l un des plus grands cabinets d avocats du pays dans la défense des droits et intérêts professionnels des fonctionnaires.",
        },
        labor: {
          title: "Droit du Travail Individuel et Collectif",
          description: "Réclamations de travail et suivi procédural",
          details:
            "Réclamations de travail (heures supplémentaires, prime de danger/insalubrité, promotions, prime de transfert, relation de travail, stabilité maternité, demande de complément de retraite).",
        },
        union: {
          title: "Droit Syndical",
          description: "Conseil complet pour les entités syndicales",
          details:
            "Notre cabinet gère un portefeuille de grands clients composé de nombreuses associations, syndicats et autres entités représentatives des fonctionnaires.",
        },
        socialSecurity: {
          title: "Droit de la Sécurité Sociale",
          description: "Octroi et révision des prestations de sécurité sociale",
          details:
            "Nous travaillons dans le Régime Propre de Prévoyance des Fonctionnaires, dans le Régime Général et dans les régimes de prévoyance complémentaire.",
        },
        constitutional: {
          title: "Droit Constitutionnel",
          description: "Élaboration d ADI et recours extraordinaires",
          details:
            "Domaine de spécialisation du cabinet lié au suivi, à l élaboration et au développement de thèses juridiques impliquant des questions constitutionnelles.",
        },
        criminal: {
          title: "Droit Pénal",
          description: "Habeas Corpus et recours pénaux",
          details:
            "Le Droit Pénal fait récemment partie des domaines de pratique de notre cabinet. Nous travaillons en partenariat avec des professionnels hautement expérimentés.",
        },
        electoral: {
          title: "Droit Électoral",
          description: "Conseil électoral complet",
          details:
            "Conseil électoral aux partis, candidats, élaboration de recours, plaidoiries orales et autres mesures administratives devant les Tribunaux Électoraux.",
        },
        superiorCourts: {
          title: "Cours Supérieures",
          description: "Pratique à Brasilia devant les Cours Supérieures",
          details:
            "MOTA & AVOCATS ASSOCIÉS est l un des cabinets avec une activité intense devant les Cours Supérieures, notamment STJ, TST et STF.",
        },
        realEstate: {
          ...
          details:
            "Nous travaillons sur tous les fronts du droit immobilier, y compris la structuration d entreprise, le recouvrement de créances, le conseil en achat, vente et location.",
        },
        family: {
          title: "Droit de la Famille et des Successions",
          description:
            "Inventaires, divorces, pensions alimentaires et successions",
          details:
            "Nous accordons une attention particulière à ce domaine en raison de sa connexion avec d autres domaines de notre travail.",
        },
        publicTreasury: {
          title: "Trésor Public et Entités Fédérées",
          description:
            "Actions contre l Union, les États, le DF et les Municipalités",
          details:
            "Ce domaine de pratique couvre les actions de recouvrement, les indemnisations, les exécutions contre le Trésor Public de l Union, des États, du DF et des Municipalités.",
        },
        mediation: {
          title: "Médiation et Conciliation",
          description: "Méthodes alternatives de résolution des conflits",
          details:
            "Il s agit d un domaine dédié aux méthodes alternatives de résolution des conflits, mené par des professionnels spécialisés dans les techniques de négociation.",
        },
        taxBusiness: {
          title: "Droit Fiscal et des Affaires",
          description: "Conseil juridique aux entreprises et matières fiscales",
          details:
            "Face à la demande croissante dans ce domaine, le cabinet a structuré une équipe exclusive, coordonnée par des avocats spécialisés.",
        },
      },
    },
    lawyers: {
      title: "Associés",
      intro:
        "Rencontrez les associés qui dirigent MOTA & AVOCATS ASSOCIÉS avec excellence et engagement.",
      swipeHint: "← Glissez pour naviguer →",
      prev: "Précédent",
      next: "Suivant",
    },
    ...
    processConsultation: {
      ...
      processNumberPlaceholder:
        "Numéro de dossier (ex: 0000000-00.0000.0.00.0000)",
      ...
      successMessage:
        "Vous recevrez la mise à jour du dossier par email sous peu.",
      error: "Erreur",
    ...
    footer: {
      description:
        "Excellence en droit avec éthique, transparence et engagement.",
    ...
    blog: {
      title: "Blog",
      subtitle:
        "Articles, actualités et analyses sur les dernières évolutions de la législation et jurisprudence brésilienne.",
    ...
    latestNews: {
      ...
      subtitle:
        "Restez informé des dernières évolutions juridiques et des nouvelles de notre cabinet.",
      viewAll: "Voir toutes les actualités",
    },
    avalie: {
      heroTitle: "Votre avis compte",
      heroSubtitle:
        "Aidez-nous à continuer d’offrir des services juridiques d’excellence",
    ...
    trabalheConosco: {
      ...
      heroSubtitle:
        "Rejoignez-nous et construisez l’avenir de la profession avec éthique, innovation et engagement pour les résultats.",
      ...
      benefits: {
        ...
        challengingDesc:
          "Participez à des dossiers complexes et pertinents dans diverses branches du droit.",
        growthTitle: "Évolution professionnelle",
        growthDesc:
          "Développez votre carrière dans un cabinet avec tradition et excellence juridique.",
      },
      ...
      fields: {
        ...
        messagePlaceholder:
          "Parlez-nous de votre expérience et pourquoi vous souhaitez travailler avec nous...",
      },
      roles: {
        intern: "Stagiaire",
      ...
      resumeBox: {
        title: "Envoi du CV",
        description:
          "Après l’envoi de ce formulaire, vous serez redirigé vers WhatsApp où vous pourrez joindre votre CV.",
      },
      submit: "Envoyer",
      submitting: "Envoi...",
    ...
    admin: {
      ...
      deletePostDesc:
        "Cette action ne peut pas être annulée. Le post sera définitivement supprimé.",
      cancel: "Annuler",
      delete: "Supprimer",
      ...
      deleteCategoryDesc:
        "Cette action ne peut pas être annulée. Les posts liés resteront sans catégorie.",
      accessDenied: "Accès Refusé",
      accessDeniedDesc:
        "Vous n'avez pas la permission d'accéder à cette page. Contactez l'administrateur.",
      backToSite: "Retour au Site",
      ...
      importFromUrlDesc:
        "Collez un lien d'article pour remplir automatiquement avec l'IA",
      ...
      htmlHint:
        "Vous pouvez utiliser HTML pour le formatage (h2, h3, p, ul, li, strong, em, a, etc.)",
      ...
      metaDescriptionHint:
        "Max. 160 caractères. Laissez vide pour utiliser l'extrait.",
      ...
      saveBeforeTranslating:
        "Enregistrez le post avant de générer les traductions",
      validation: {
  ...
  zh: {
    ...
    about: {
      ...
      pillars: {
        ...
        content1:
          "莫塔律师事务所的实践建立在道德辩护、认真、严肃和高效工作的原则之上，关注社会变化和每位客户的需求，同时不放弃良好的技术和律师在寻求有效解决方案中的社会角色。",
        content2:
          "我们的目标是通过提供法律上合格的工作来促进社会关系的平衡，优先考虑与客户的专业关系。",
        content3:
          "我们的实践，无论是预防性的、行政性的还是司法性的，都专注于寻求权利保障、法律安全，最重要的是重视我们最强大的优势：人员和对所完成工作的满意度。",
      },
      mission: {
        title: "我们的使命",
        badge: "卓越",
        ...
        content:
          "我们是一个不断发展的社会的一部分，这反映了我们团队持续培训的必要性。立法、监管和司法判例的变化要求越来越多的技术资格和新技术的融入，以便为客户提供满意的服务，实现效率、解决问题，最重要的是敏捷性。",
      },
      office: {
        title: "事务所",
        badge: "全国覆盖",
    ...
    practiceAreas: {
      ...
      areas: {
        administrative: {
          ...
          details:
            "在我们的发展历程中，我们已成为该国在捍卫公务员专业权利和利益方面最大的律师事务所之一。",
        },
        labor: {
          title: "个人和集体劳动法",
          description: "劳动索赔和程序跟进",
          details:
            "劳动索赔（加班费、危险/不健康津贴、晋升、调动津贴、劳动关系、孕妇稳定性、退休补充申请）。",
        },
        union: {
          title: "工会法",
          description: "为工会实体提供全面咨询",
          details:
            "我们的事务所管理着由众多协会、工会和其他公务员代表机构组成的大客户群。",
        },
        socialSecurity: {
          title: "社会保障法",
          description: "社会保障福利的授予和审查",
          details:
            "我们在公务员自身社会保障制度、一般制度和补充社会保障制度中工作。",
        },
        constitutional: {
          title: "宪法",
          description: "编制ADI和非常上诉",
          details:
            "事务所的专业领域，涉及监测、编制和发展涉及宪法事项的法律论点。",
        },
        criminal: {
          title: "刑法",
          description: "人身保护令和刑事上诉",
          details:
            "刑法最近成为我们事务所的业务领域之一。我们与经验丰富的专业人士合作。",
        },
        electoral: {
          title: "选举法",
          description: "完整的选举咨询",
          details:
            "为政党、候选人提供选举咨询，编制上诉、口头辩论和其他选举法庭的行政措施。",
        },
        superiorCourts: {
          title: "上级法院",
          description: "在巴西利亚的上级法院执业",
          details:
            "莫塔律师事务所是在上级法院有密集活动的事务所之一，特别是STJ、TST和STF。",
        },
        realEstate: {
          title: "房地产法",
          description: "房地产业务和正规化的全面咨询",
          details:
            "我们在房地产法的各个方面开展工作，包括业务结构、债务追收、买卖和租赁咨询。",
        },
        family: {
          title: "家庭和继承法",
        ...
        publicTreasury: {
          ...
          details:
            "该业务领域涵盖追收诉讼、赔偿、针对联邦、州、联邦区和市政府公共财政的执行。",
        },
        mediation: {
          title: "调解与和解",
          description: "冲突解决的替代方法",
          details:
            "这是一个致力于冲突解决替代方法的领域，由专门从事谈判技巧的专业人员进行。",
        },
        taxBusiness: {
          title: "税务和商业法",
          description: "为企业和税务事项提供法律咨询",
          details:
            "鉴于该领域需求不断增长，事务所组建了一个由专业律师协调的专属团队。",
        },
      },
    },
    lawyers: {
    ...
    cookies: {
      title: "Cookie政策",
      message:
        "我们使用Cookie来改善您在我们网站上的体验。继续浏览即表示您同意我们的隐私政策。",
      accept: "接受",
      decline: "拒绝",
    },
    blog: {
    ...
    trabalheConosco: {
      ...
      resumeBox: {
        title: "简历提交",
        description:
          "提交表单后，你将跳转到 WhatsApp，在那里可以附加你的简历。",
      },
      submit: "发送",
      submitting: "发送中...",
      backHome: "返回首页",
    ...
    admin: {
      ...
      htmlHint:
        "您可以使用HTML进行格式化（h2, h3, p, ul, li, strong, em, a等）",
      featuredImage: "特色图片",
      uploadImage: "上传图片",
      orPasteUrl: "或粘贴URL",
      organization: "组织",
